	...
	(function(angular) {
	    ...
	    myModule.controller('main', ['$scope', '$templateCache', '$filter', function($scope, $templateCache, $filter) {
	        ...
	        $scope.tableData = {
	            ...
	            thead:[$scope.LTableOrderSeq,$scope.LTableOperatorsName,$scope.LTableOperatorsLevel,$scope.LTableOperatorsParent,$scope.LDetailOperatorsContactPhone,$scope.LTableOperator,$scope.LTableDelete],
	            tbody:[
	             ...
	             Api.companyDelete(data, function (json) {
	                ...
	                else
	                {
	                    ...
	                    if(json.msg.http_code==400&&json.msg.statusCode==400){
	                        Alert.show($scope.LOperatorDeleteFailTips);
	                    }else{
	        ...
	        $scope.onSelectPage = function(page){
	            ...
	            Api.companyQuery(data, function (json) {
	                ...
	                list.map(function (e,i) {
	                    ...
	                    arr[5] = '<a href="operators_info.html?id='+e.id+'"  target="_blank">' + $scope.LTableDetails + '</a>';
