...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(angular) {
	    'use strict';
	    angular.module('operatorNew', ['ngSanitize'])
	        .controller('main', function($scope, $templateCache, $filter) {
	            ...
	            $scope.submit = function () {
	                ...
	                Api.createCompany(data, function (json) {
	                    if(json.statusCode == 0){
	                        location.href = 'oparator_user.html';
	                    }else{
	                        Alert.show(Lang.LSystemError);
	                    }
	                })
	            }
	        })
