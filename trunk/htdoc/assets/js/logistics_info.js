	        ...
	        Api.userInfo(function(json){
	            if(json.statusCode != 0){
	                ...
	                if($scope.userrole=="LOGISTICS_COMPANY_USER"){
	                    $scope.info.title=$scope.LOperatorInfo + ' <a href="logistics_edit.html?id=' + id + '"><small>>></small></a>';
	                    $scope.info.secondTitle=$scope.LLinkmanInfo  + ' <a href="logistics_user.html?id=' + id + '"><small>>></small></a>';
	                }
	                else{
	                    $scope.info.title=$scope.LOperatorInfo + ' <a href="logistics_edit.html?id=' + id + '"><small>>>' + $scope.LToEdit + '</small></a>';
