    ...
    DateRangePicker.prototype = {
        ...
        updateMonthsInView: function() {
            if (this.endDate) {
                ...
                console.log(this.leftCalendar.month.format())
        ...
        updateCalendars: function() {
            ...
            //this.rightCalendar.month.subtract(1, 'month')
            //console.log(this.leftCalendar.month.format())
            //console.log(this.rightCalendar.month.format())
        ...
        show: function(e) {
            ...
            this.startDate = this.startDate ? this.startDate.clone() : moment().startOf('day');
            this.endDate = this.endDate ? this.endDate.clone() : moment().endOf('day');
            ...
            this.oldStartDate = this.startDate ? this.startDate.clone() : moment().startOf('day');
            this.oldEndDate = this.endDate ? this.endDate.clone() : moment().endOf('day');
        ...
        hide: function(e) {
            ...
            if (!this.startDate || !this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))
