...
public class ReportFormHttpServer extends NanoHTTPD{
    ...
    public Response serve(String uri, Method method, Map<String, String> headers, Map<String, String> parms,
        ...
        if ("GET".equalsIgnoreCase(method.toString())) {
            ...
            Utils.log(parms.get(NanoHTTPD.QUERY_STRING_PARAMETER));
        }
    ...
    private Response handleImportExpress(Map<String, String> parms,String uri){
        Utils.log(parms.get("path"));
        Utils.log(parms.get("userToken"));
        Utils.log(parms.get("id"));
    ...
    private Response handleExportExcel(Map<String, String> parms){
        ...
        try{
            return new Response(Response.Status.OK, "application/vnd.ms-excel; charset=utf-8", ExcelExport.exportExpressExcel(id, path, ExpressQuery.getAllExpress(userToken, HttpUtils.getHashMap(parms),1), language,parms));
        }catch (Exception e){
