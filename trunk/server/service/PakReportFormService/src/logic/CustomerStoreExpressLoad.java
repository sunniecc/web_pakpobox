        ...
        try {
            ...
            for (int i = 1 ;i < rows ; i++){
                ...
                if (Config.TYPE_IMPORT_NORMAL == importType){
                    ...
                    exp.recipientName = getCellValue(r,5);
                    exp.recipientUserPhoneNumber = getCellValue(r,6);
                    exp.designationSize = getCellValue(r,7);
                    exp.takeUserMail = getCellValue(r,8);
                    exp.endAddress = getCellValue(r,9);
