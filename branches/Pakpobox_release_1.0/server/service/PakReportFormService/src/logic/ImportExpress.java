...
public class ImportExpress {
    public static String importExpress(String path,String uri,String id,String userToken){
        ...
        try{
            ...
            for (ImportExpModel item : list){
                if (importType == Config.TYPE_IMPORT_NORMAL) {
                    ...
                    if (httpResponse.getStatusLine().getStatusCode() != HttpStatus.SC_ACCEPTED){
                        ...
                        System.out.println(httpResponse.getStatusLine().getStatusCode() + " = " + HttpUtils.getHttpResultStr(httpResponse));
                    }else{
                        System.out.println(httpResponse.getStatusLine().getStatusCode() + " = " + HttpUtils.getHttpResultStr(httpResponse));
                    }
           ...
           if (count % Config.MAX_PER_POST_COUNT != 0) {
            ...
            System.out.println("failed = " + sumFailed);
    ...
    public static void showItem(ImportExpModel item){
        System.out.println("show item key = " + item.key + " value = " + item.value);
    }
