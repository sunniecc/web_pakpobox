...
(function(angular) {
    ...
    myModule.controller('main', ['$scope', '$templateCache', '$filter', function($scope, $templateCache, $filter) {
        ...
        $scope.info = {
            title : $scope.LOperatorInfo + ' <a href="operator_edit.html?id=' + id + '"><small>>>' + $scope.LToEdit + '</small></a>',
            secondTitle : $scope.LLinkmanInfo  + ' <a href="operator_user.html?id=' + id + '"><small>>>' + $scope.LToEdit + '</small></a>',
            content:[
            ]
        };
